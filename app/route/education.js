...
router.post("/", (req, res) => {
    const { school, college, degree, other_details, achievements, trainer_id } = req.body;
...
router.get("/byTrainerId/:trainerId", (req, res) => {
    Education.find({ trainer_id: req.params.trainerId })
        .then((result) => {
            res.status(200).json({
